                                ...
                                <div className="md:flex">
                                        <div data-aos="zoom-in" className="md:w-1/2 px-3 md:pl-16">
                                                ...
                                                <div className='pl-20 md:pl-0'>
                                                        ...
                                                        <p className="mt-1 md:mt-2 text-gray">Data Structure build through array, linked list, trees, <br /> graphs. What will you build?</p> <br />
                                                        <h3 className="text-xl md:text-2xl font-bold">Be in demand</h3>
                                                        <p className="mt-1 md:mt-2 text-gray">With 1.7 billion websites on the internet, it is one of the hottest career options with an average fresher salary of 6 LPA for Competitive Programming according to CodeChef, Leetcode and so on.</p> <br />
