...
const StudentReview = (props) => {
  const { video } = props;
  return (
      <div className=" mentorship-card-shadow overflow-hidden md:ml-5 lg:ml-8 px-10  p-2  min-w-[50%] min-h-[99%] md:w-[96%] hover:bg-opacity-20 bg-opacity-10 lg:w-[97%] rounded-[30px] lg:h-[98%] ">
        ...
        <div className="card-body flex justify-center min-h-[50%] min-w-[30%] items-center">
          {video ? (
            <iframe
              className="xxs:w-[220px] xxs:pt-2 xs:w-[280px] sm:w-[300px] sm:h-[350px] min-w-[200px] min-h-[30%]  md:w-[300px] md:h-[250px] lg:w-[280px] lg:h-[200px] rounded-3xl border-solid border-[#1ab79d]"
              src={video}
              title="YouTube Video"
