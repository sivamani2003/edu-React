...
import yesOrNo from '../../../assets/Yes_or_no.png'
                ...
                <div>
                        <div className='flex flex-col px-2 md:flex-row-reverse'>
                                <div className='md:w-1/2 flex justify-center'>
                                        <img className='w-[70%] h-[80%]' src={yesOrNo} alt="" />
                                </div>
                                <div className='md:w-1/2'>
                                        <div>
                                                <h1 className='text-xl font-bold md:text-5xl text-blue'>WHY <span className='text-gradient'>MENTORSHIP</span> ?</h1>
                                        ...
                                        <div className='mt-8'>
                                                <div className='flex items-center gap-x-4'>
                                                        <div>
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="bg-[#fb5021] shadow-lg text-white p-4 rounded-full w-16 h-20">
